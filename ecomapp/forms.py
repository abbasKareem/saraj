...
#         widgets = {
#             'shipping_address': forms.TextInput(attrs={'style': 'display:none;'}),
#         }
...
class CheckoutForm(forms.ModelForm):
    payment_method = forms.ChoiceField(choices=METHOD)
    ...
    class Meta:
        ...
        widgets = {
            'shipping_address': forms.TextInput(attrs={'style': 'display:none;'}),
            'payment_method': forms.Select(attrs={'style': 'display:none;'}),
        }
        labels = {
            'shipping_address': '',
            'payment_method': '',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['payment_method'].initial = METHOD[0][0]  # set default to the first choice
